# Quellen: https://coderslegacy.com/python/python-pygame-tutorial/
...
#           "scrolling background" (Quelle 2) angepasst und ergänzt
#           "make the background move down" (Kommentar in Quelle 2)                
...
class Background():
    def __init__(self):
        ...
        self.bgimage = pygame.image.load("animated_street.png")
        # Rechteck in der Größe des Bildes erzeugen
        self.rectBGimg = self.bgimage.get_rect()
        # Punkt in der oberen linken Ecke des Fensters            
        self.bgY1 = 0
        self.bgX1 = 0
        # Punkt am Ende des Fensters (zunächst nicht sichtbar)  
        self.bgY2 = self.rectBGimg.height
        self.bgX2 = 0
        # Scrolling speed des Hintergrunds 
        self.movingUpSpeed = 5
    # Methode scrollt den Hintergrund   
    def update(self):
        # Punkt nach unten verschieben  
        self.bgY1 += self.movingUpSpeed
        self.bgY2 += self.movingUpSpeed
        # wenn der Punkt unten angekommen ist
        if self.bgY1 >= self.rectBGimg.height:
            # zurücksetzen auf die Position oben            
            self.bgY1 = -self.rectBGimg.height
        # wenn der Punkt unten angekommen ist
        if self.bgY2 >= self.rectBGimg.height:
            # zurücksetzen auf die Position oben            
            self.bgY2 = -self.rectBGimg.height
    # Methode zeichnet den Hintergrund in das Fenster       
    def render(self):
        # Blocktransfer der ersten Kopie des Hintergrunds
        screen.blit(self.bgimage, (self.bgX1, self.bgY1))
        # Blocktransfer der zweiten Kopie des Hintergrunds      
